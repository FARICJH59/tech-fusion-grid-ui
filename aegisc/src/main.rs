...
fn main(){
 ...
 println!("Aegis Compiler v0.1.0"); println!("Compiling {path}...\n");
 let tokens=match lexer::lex(&source){Ok(t)=>t,Err(e)=>{eprintln!("{e}");process::exit(1)}}; println!("Lexer........................ PASS");
 let ast=match parser::parse(&tokens){Ok(a)=>a,Err(e)=>{eprintln!("{e}");process::exit(1)}}; println!("Parser....................... PASS");
 if let Err(e)=linear::check_program(&ast){eprintln!("{e}");process::exit(1)}
 println!("Linear lease checking........ PASS"); println!("\nAegis v0.1 compilation succeeded.");
}
